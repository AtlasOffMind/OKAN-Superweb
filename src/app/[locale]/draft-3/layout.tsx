...
export default async function Draft3Layout({
  ...
  return (
    <div className="relative bg-zinc-950 text-zinc-100">
      <ScrollHeader className="top-5 right-6 md:top-8 md:right-10">
        <NavDrawer
          links={links}
      ...
      <footer className="relative overflow-hidden border-t border-zinc-800 bg-[linear-gradient(135deg,#000000_0%,#3b0764_55%,#000000_100%)] px-6 py-16 md:px-10">
