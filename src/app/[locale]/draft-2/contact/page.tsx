...
export default async function Draft2Contact({
  params,
}: {
    ...
    <>
      ...
      <section className="px-6 py-20 md:px-12">
        <div className="mx-auto grid max-w-6xl gap-16 md:grid-cols-2">
          ...
          <form className="flex flex-col gap-5 rounded-3xl border border-zinc-200 p-8 shadow-sm">
            ...
            <button
              type="submit"
              className="bg-brand-700 hover:bg-brand-800 rounded-xl px-6 py-3 text-sm font-semibold text-white transition-colors"
            >
              {t("form.submit")}
            </button>
          </form>
